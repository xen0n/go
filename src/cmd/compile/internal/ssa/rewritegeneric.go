...
func rewriteValuegeneric_OpEq16(v *Value) bool {
	...
	// match: (Eq16 (Const16 <t> [c]) (Ctz64 x))
	// cond: c > 64
	...
	// match: (Eq16 (Const16 <t> [c]) (Ctz32 x))
	// cond: c > 32
	// result: (ConstBool [false])
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
	...
	// match: (Eq16 (Const16 <t> [c]) (Ctz16 x))
	// cond: c > 16
	// result: (ConstBool [false])
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
...
func rewriteValuegeneric_OpEq32(v *Value) bool {
	...
	// match: (Eq32 (Const32 <t> [c]) (Ctz64 x))
	// cond: c > 64
	// result: (ConstBool [false])
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
	...
	// match: (Eq32 (Const32 <t> [c]) (Ctz32 x))
	// cond: c > 32
	// result: (ConstBool [false])
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
	...
	// match: (Eq32 (Const32 <t> [c]) (Ctz16 x))
	// cond: c > 16
	// result: (ConstBool [false])
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
...
func rewriteValuegeneric_OpEq64(v *Value) bool {
	...
	// match: (Eq64 (Const64 <t> [c]) (Ctz64 x))
	// cond: c > 64
	// result: (ConstBool [false])
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
	...
	// match: (Eq64 (Const64 <t> [c]) (Ctz32 x))
	// cond: c > 32
	// result: (ConstBool [false])
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
	...
	// match: (Eq64 (Const64 <t> [c]) (Ctz16 x))
	// cond: c > 16
	// result: (ConstBool [false])
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
...
func rewriteValuegeneric_OpLeq16(v *Value) bool {
	...
	for {
		...
		t := v_1.Type
		if auxIntToInt16(v_1.AuxInt) != 63 || !(config.PtrSize == 8) {
			break
		}
		v.reset(OpNeq16)
		v0 := b.NewValue0(v.Pos, OpConst16, t)
	...
	for {
		...
		t := v_1.Type
		if auxIntToInt16(v_1.AuxInt) != 31 {
			break
		}
		v.reset(OpNeq16)
		v0 := b.NewValue0(v.Pos, OpConst16, t)
	...
	for {
		...
		t := v_1.Type
		if auxIntToInt16(v_1.AuxInt) != 15 {
			break
		}
		v.reset(OpNeq16)
		v0 := b.NewValue0(v.Pos, OpConst16, t)
...
func rewriteValuegeneric_OpLeq32(v *Value) bool {
	...
	for {
		...
		t := v_1.Type
		if auxIntToInt32(v_1.AuxInt) != 63 || !(config.PtrSize == 8) {
			break
		}
		v.reset(OpNeq32)
		v0 := b.NewValue0(v.Pos, OpConst32, t)
	...
	for {
		...
		t := v_1.Type
		if auxIntToInt32(v_1.AuxInt) != 31 {
			break
		}
		v.reset(OpNeq32)
		v0 := b.NewValue0(v.Pos, OpConst32, t)
	...
	for {
		...
		t := v_1.Type
		if auxIntToInt32(v_1.AuxInt) != 15 {
			break
		}
		v.reset(OpNeq32)
		v0 := b.NewValue0(v.Pos, OpConst32, t)
...
func rewriteValuegeneric_OpLeq32U(v *Value) bool {
	...
	// match: (Leq32U (Ctz64 x) (Const32 [c]))
	// cond: c >= 64
	// result: (ConstBool [true])
	for {
		if v_0.Op != OpCtz64 {
	...
	// match: (Leq32U (Ctz32 x) (Const32 [c]))
	// cond: c >= 32
	// result: (ConstBool [true])
	for {
		if v_0.Op != OpCtz32 {
	...
	// match: (Leq32U (Ctz16 x) (Const32 [c]))
	// cond: c >= 16
	// result: (ConstBool [true])
	for {
		if v_0.Op != OpCtz16 {
	...
	// match: (Leq32U (Const32 [c]) (Ctz64 x))
	// cond: c > 64
	// result: (ConstBool [false])
	for {
		if v_0.Op != OpConst32 {
	...
	// match: (Leq32U (Const32 [c]) (Ctz32 x))
	// cond: c > 32
	// result: (ConstBool [false])
	for {
		if v_0.Op != OpConst32 {
	...
	// match: (Leq32U (Const32 [c]) (Ctz16 x))
	// cond: c > 16
	// result: (ConstBool [false])
	for {
		if v_0.Op != OpConst32 {
...
func rewriteValuegeneric_OpLeq64(v *Value) bool {
	...
	for {
		...
		t := v_1.Type
		if auxIntToInt64(v_1.AuxInt) != 63 || !(config.PtrSize == 8) {
			break
		}
		v.reset(OpNeq64)
		v0 := b.NewValue0(v.Pos, OpConst64, t)
...
func rewriteValuegeneric_OpLeq64U(v *Value) bool {
	...
	// match: (Leq64U (Ctz64 x) (Const64 [c]))
	// cond: c >= 64
	// result: (ConstBool [true])
	for {
		if v_0.Op != OpCtz64 {
	...
	// match: (Leq64U (Ctz32 x) (Const64 [c]))
	// cond: c >= 32
	// result: (ConstBool [true])
	for {
		if v_0.Op != OpCtz32 {
	...
	// match: (Leq64U (Ctz16 x) (Const64 [c]))
	// cond: c >= 16
	// result: (ConstBool [true])
	for {
		if v_0.Op != OpCtz16 {
	...
	// match: (Leq64U (Const64 [c]) (Ctz64 x))
	// cond: c > 64
	// result: (ConstBool [false])
	for {
		if v_0.Op != OpConst64 {
	...
	// match: (Leq64U (Const64 [c]) (Ctz32 x))
	// cond: c > 32
	// result: (ConstBool [false])
	for {
		if v_0.Op != OpConst64 {
	...
	// match: (Leq64U (Const64 [c]) (Ctz16 x))
	// cond: c > 16
	// result: (ConstBool [false])
	for {
		if v_0.Op != OpConst64 {
...
func rewriteValuegeneric_OpLeq8(v *Value) bool {
	...
	for {
		...
		t := v_1.Type
		if auxIntToInt8(v_1.AuxInt) != 63 || !(config.PtrSize == 8) {
			break
		}
		v.reset(OpNeq8)
		v0 := b.NewValue0(v.Pos, OpConst8, t)
...
func rewriteValuegeneric_OpLess16(v *Value) bool {
	...
	for {
		...
		t := v_1.Type
		if auxIntToInt16(v_1.AuxInt) != 64 || !(config.PtrSize == 8) {
			break
		}
		v.reset(OpNeq16)
		v0 := b.NewValue0(v.Pos, OpConst16, t)
	...
	for {
		...
		t := v_1.Type
		if auxIntToInt16(v_1.AuxInt) != 32 {
			break
		}
		v.reset(OpNeq16)
		v0 := b.NewValue0(v.Pos, OpConst16, t)
	...
	for {
		...
		t := v_1.Type
		if auxIntToInt16(v_1.AuxInt) != 16 {
			break
		}
		v.reset(OpNeq16)
		v0 := b.NewValue0(v.Pos, OpConst16, t)
...
func rewriteValuegeneric_OpLess32(v *Value) bool {
	...
	for {
		...
		t := v_1.Type
		if auxIntToInt32(v_1.AuxInt) != 64 || !(config.PtrSize == 8) {
			break
		}
		v.reset(OpNeq32)
		v0 := b.NewValue0(v.Pos, OpConst32, t)
	...
	for {
		...
		t := v_1.Type
		if auxIntToInt32(v_1.AuxInt) != 32 {
			break
		}
		v.reset(OpNeq32)
		v0 := b.NewValue0(v.Pos, OpConst32, t)
	...
	for {
		...
		t := v_1.Type
		if auxIntToInt32(v_1.AuxInt) != 16 {
			break
		}
		v.reset(OpNeq32)
		v0 := b.NewValue0(v.Pos, OpConst32, t)
	...
	// match: (Less32 (Ctz64 x) (Const32 [c]))
	// cond: c > 64
	// result: (ConstBool [true])
	for {
		if v_0.Op != OpCtz64 {
	...
	// match: (Less32 (Ctz32 x) (Const32 [c]))
	// cond: c > 32
	// result: (ConstBool [true])
	for {
		if v_0.Op != OpCtz32 {
	...
	// match: (Less32 (Ctz16 x) (Const32 [c]))
	// cond: c > 16
	// result: (ConstBool [true])
	for {
		if v_0.Op != OpCtz16 {
	...
	// match: (Less32 (Const32 [c]) (Ctz64 x))
	// cond: c >= 64
	// result: (ConstBool [false])
	for {
		if v_0.Op != OpConst32 {
	...
	// match: (Less32 (Const32 [c]) (Ctz32 x))
	// cond: c >= 32
	// result: (ConstBool [false])
	for {
		if v_0.Op != OpConst32 {
	...
	// match: (Less32 (Const32 [c]) (Ctz16 x))
	// cond: c >= 16
	// result: (ConstBool [false])
	for {
		if v_0.Op != OpConst32 {
...
func rewriteValuegeneric_OpLess32U(v *Value) bool {
	...
	// match: (Less32U (Ctz64 x) (Const32 [c]))
	// cond: c > 64
	// result: (ConstBool [true])
	for {
		if v_0.Op != OpCtz64 {
	...
	// match: (Less32U (Ctz32 x) (Const32 [c]))
	// cond: c > 32
	// result: (ConstBool [true])
	for {
		if v_0.Op != OpCtz32 {
	...
	// match: (Less32U (Ctz16 x) (Const32 [c]))
	// cond: c > 16
	// result: (ConstBool [true])
	for {
		if v_0.Op != OpCtz16 {
	...
	// match: (Less32U (Ctz8 x) (Const32 [c]))
	// cond: c > 8
	// result: (ConstBool [true])
	for {
		if v_0.Op != OpCtz8 {
	...
	// match: (Less32U (Const32 [c]) (Ctz64 x))
	// cond: c >= 64
	// result: (ConstBool [false])
	for {
		if v_0.Op != OpConst32 {
	...
	// match: (Less32U (Const32 [c]) (Ctz32 x))
	// cond: c >= 32
	// result: (ConstBool [false])
	for {
		if v_0.Op != OpConst32 {
	...
	// match: (Less32U (Const32 [c]) (Ctz16 x))
	// cond: c >= 16
	// result: (ConstBool [false])
	for {
		if v_0.Op != OpConst32 {
	...
	// match: (Less32U (Const32 [c]) (Ctz8 x))
	// cond: c >= 8
	// result: (ConstBool [false])
	for {
		if v_0.Op != OpConst32 {
...
func rewriteValuegeneric_OpLess64(v *Value) bool {
	...
	for {
		...
		t := v_1.Type
		if auxIntToInt64(v_1.AuxInt) != 64 || !(config.PtrSize == 8) {
			break
		}
		v.reset(OpNeq64)
		v0 := b.NewValue0(v.Pos, OpConst64, t)
	...
	for {
		...
		t := v_1.Type
		if auxIntToInt64(v_1.AuxInt) != 32 {
			break
		}
		v.reset(OpNeq64)
		v0 := b.NewValue0(v.Pos, OpConst64, t)
	...
	for {
		...
		t := v_1.Type
		if auxIntToInt64(v_1.AuxInt) != 16 {
			break
		}
		v.reset(OpNeq64)
		v0 := b.NewValue0(v.Pos, OpConst64, t)
	...
	// match: (Less64 (Ctz64 x) (Const64 [c]))
	// cond: c > 64
	// result: (ConstBool [true])
	for {
		if v_0.Op != OpCtz64 {
	...
	// match: (Less64 (Ctz32 x) (Const64 [c]))
	// cond: c > 32
	// result: (ConstBool [true])
	for {
		if v_0.Op != OpCtz32 {
	...
	// match: (Less64 (Ctz16 x) (Const64 [c]))
	// cond: c > 16
	// result: (ConstBool [true])
	for {
		if v_0.Op != OpCtz16 {
	...
	// match: (Less64 (Const64 [c]) (Ctz64 x))
	// cond: c >= 64
	// result: (ConstBool [false])
	for {
		if v_0.Op != OpConst64 {
	...
	// match: (Less64 (Const64 [c]) (Ctz32 x))
	// cond: c >= 32
	// result: (ConstBool [false])
	for {
		if v_0.Op != OpConst64 {
	...
	// match: (Less64 (Const64 [c]) (Ctz16 x))
	// cond: c >= 16
	// result: (ConstBool [false])
	for {
		if v_0.Op != OpConst64 {
...
func rewriteValuegeneric_OpLess64U(v *Value) bool {
	...
	// match: (Less64U (Ctz64 x) (Const64 [c]))
	// cond: c > 64
	// result: (ConstBool [true])
	for {
		if v_0.Op != OpCtz64 {
	...
	// match: (Less64U (Ctz32 x) (Const64 [c]))
	// cond: c > 32
	// result: (ConstBool [true])
	for {
		if v_0.Op != OpCtz32 {
	...
	// match: (Less64U (Ctz16 x) (Const64 [c]))
	// cond: c > 16
	// result: (ConstBool [true])
	for {
		if v_0.Op != OpCtz16 {
	...
	// match: (Less64U (Ctz8 x) (Const64 [c]))
	// cond: c > 8
	// result: (ConstBool [true])
	for {
		if v_0.Op != OpCtz8 {
	...
	// match: (Less64U (Const64 [c]) (Ctz64 x))
	// cond: c >= 64
	// result: (ConstBool [false])
	for {
		if v_0.Op != OpConst64 {
	...
	// match: (Less64U (Const64 [c]) (Ctz32 x))
	// cond: c >= 32
	// result: (ConstBool [false])
	for {
		if v_0.Op != OpConst64 {
	...
	// match: (Less64U (Const64 [c]) (Ctz16 x))
	// cond: c >= 16
	// result: (ConstBool [false])
	for {
		if v_0.Op != OpConst64 {
	...
	// match: (Less64U (Const64 [c]) (Ctz8 x))
	// cond: c >= 8
	// result: (ConstBool [false])
	for {
		if v_0.Op != OpConst64 {
...
func rewriteValuegeneric_OpLess8(v *Value) bool {
	...
	for {
		...
		t := v_1.Type
		if auxIntToInt8(v_1.AuxInt) != 64 || !(config.PtrSize == 8) {
			break
		}
		v.reset(OpNeq8)
		v0 := b.NewValue0(v.Pos, OpConst8, t)
...
func rewriteValuegeneric_OpNeq16(v *Value) bool {
	...
	// match: (Neq16 (Const16 <t> [c]) (Ctz64 x))
	// cond: c > 64
	// result: (ConstBool [false])
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
	...
	// match: (Neq16 (Const16 <t> [c]) (Ctz32 x))
	// cond: c > 32
	// result: (ConstBool [false])
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
	...
	// match: (Neq16 (Const16 <t> [c]) (Ctz16 x))
	// cond: c > 16
	// result: (ConstBool [false])
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
	...
	// match: (Neq16 (Const16 <t> [c]) (Ctz8 x))
	// cond: c > 8
	// result: (ConstBool [false])
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
...
func rewriteValuegeneric_OpNeq32(v *Value) bool {
	...
	// match: (Neq32 (Const32 <t> [c]) (Ctz64 x))
	// cond: c > 64
	// result: (ConstBool [false])
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
	...
	// match: (Neq32 (Const32 <t> [c]) (Ctz32 x))
	// cond: c > 32
	// result: (ConstBool [false])
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
	...
	// match: (Neq32 (Const32 <t> [c]) (Ctz16 x))
	// cond: c > 16
	// result: (ConstBool [false])
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
	...
	// match: (Neq32 (Const32 <t> [c]) (Ctz8 x))
	// cond: c > 8
	// result: (ConstBool [false])
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
...
func rewriteValuegeneric_OpNeq64(v *Value) bool {
	...
	// match: (Neq64 (Const64 <t> [c]) (Ctz64 x))
	// cond: c > 64
	// result: (ConstBool [false])
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
	...
	// match: (Neq64 (Const64 <t> [c]) (Ctz32 x))
	// cond: c > 32
	// result: (ConstBool [false])
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
	...
	// match: (Neq64 (Const64 <t> [c]) (Ctz16 x))
	// cond: c > 16
	// result: (ConstBool [false])
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
	...
	// match: (Neq64 (Const64 <t> [c]) (Ctz8 x))
	// cond: c > 8
	// result: (ConstBool [false])
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
