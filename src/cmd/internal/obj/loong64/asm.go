...
var optab = []Optab{
	...
	{ACLOW, C_REG, C_NONE, C_NONE, C_REG, C_NONE, 64, 4, 0, 0},
	...
	{AFMADDF, C_FREG, C_REG, C_NONE, C_FREG, C_NONE, 63, 4, 0, 0},
	{AFMADDF, C_FREG, C_REG, C_FREG, C_FREG, C_NONE, 63, 4, 0, 0},
